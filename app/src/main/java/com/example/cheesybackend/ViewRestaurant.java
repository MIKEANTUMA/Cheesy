...
public class ViewRestaurant extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    private static final String TAG = ViewRestaurant.class.getSimpleName();
...
//    private TextView textLat, textLong;
    ...
    private void markerLocation(LatLng latLng) {
        ...
        if ( map!=null ) {
            ...
            CameraUpdate cameraUpdate = CameraUpdateFactory.newLatLngZoom(australiaBounds.getCenter(),10);
